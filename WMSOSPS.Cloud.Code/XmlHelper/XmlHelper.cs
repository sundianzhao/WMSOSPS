...
using System.Xml;
using System.Data;
using WMSOSPS.Cloud.Code.File;
using System;

namespace WMSOSPS.Cloud.Code.XmlHelper
{
    /// <summary>
    /// Xml的操作公共类
    /// </summary>    
    public class XmlHelper
    {
        ...
        public XmlHelper(string xmlFilePath)
        {
            ...
            else //非web程序引用   
            {
                ...
                {
                    xmlFilePath = xmlFilePath.Substring(xmlFilePath.IndexOf('\\', 1)).TrimStart('\\');   
                    //xmlFilePath = xmlFilePath.TrimStart('\\');
                }
                _filePath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, xmlFilePath);
            }
            //获取XML文件的绝对路径
            //_filePath = System.Web.HttpContext.Current.Server.MapPath(xmlFilePath);
        }
