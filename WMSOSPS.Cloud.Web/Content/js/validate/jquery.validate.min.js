...
(function (c) {
    ...
    c.extend(c.validator, {
        ...
        messages: {
            ...
            number: "请输入合法的数字",
            SFZ: "请输入合法的身份证号码",
            DHYZ: "只能填写手机号码或者带区号的固定电话",
            DHYZAgent: "号码无效",
            MDMSJ: "手机号码前加0，固定电话前带区号！",
            digits: "只能输入整数",
            creditcard: "请输入合法的信用卡号",
            equalTo: "请再次输入相同的值",
            accept: "请输入拥有合法后缀名的字符串",
            numberEnglishLeter: "请输入数字，字母或者下划线",
            decimalNumber:"请输入0-1之间的小数",
        ...
        methods: {
            ...
            numberEnglishLeter: function (a, b) {
                return this.optional(b)||/^[0-9a-zA-Z_]{1,}$/.test(a)
            },
            decimalNumber:function(a, b) {
                return this.optional(b)||/0\.[0-9]*[1-9]$/.test(a)
            },
            number: function (a, b) {
                return this.optional(b) || /^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(a)
            },
            SFZ:function (a,b){
                return this.optional(b)||/(^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$)|(^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}(X|x))$)/.test(a)
            },
            DHYZ: function (a, b) {
                return this.optional(b) || /^((0[1-9]\d{1,2}[1-9]\d{6,7})|(1[3568947]\d{9})|(0[1-9]\d{1,2}1[3568479]\d{9}))$/.test(a)
            },
            DHYZAgent: function(a, b) {
                return this.optional(b)|| /((\d{10})|(\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/.test(a) 
            },
            MDMSJ: function (a, b) {
                return this.optional(b) || /(^(01[3456789]\d{9}))|(^(0[0-9]{2,3})+([2-9][0-9]{6,8})$)/.test(a)
            },
            digits: function (a, b) {
