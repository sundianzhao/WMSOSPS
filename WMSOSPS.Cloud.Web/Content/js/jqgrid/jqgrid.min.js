    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                populate = function (npage) {
                    ...
                    if (!ts.grid.hDiv.loading) {
                        ...
                        if (pN.rows !== null) { prm[pN.rows] = ts.p.rowNum; } if (pN.page !== null) { prm[pN.page] = ts.p.page }// 原来的代码prm[pN.page] = ts.p.page; 
            ...
            $(ts).before(grid.hDiv).click(function (e) {
                ...
                //由于enter事件冲突，所以在这里要判断一下$('.ui-pg-input')的页码是多少
                ...
                if (opts.page) {
                    ...
                    var pg = parseInt($('.ui-pg-input').val());
                    if (!!pg && pg > 1 && pg <= ts.p.lastpage){
                        ts.p.page = pg
                    }
                    else if (pg > ts.p.lastpage) {
                        ts.p.page = ts.p.lastpage;
                        $('.ui-pg-input').val(ts.p.lastpage);
                    }
                    else
                        ts.p.page = page;
        ...
        getCheckDataIDs: function () {
            ...
            this.each(function () {
                ...
                if (len && len > 0) {
                    while (i < len) {
                        if ($(this.rows[i]).hasClass('jqgrow')) {
                            if ($(this.rows[i]).attr('aria-selected') == 'true') {
                                ids[j] = this.rows[i].id;
                                j++;
                            }
                            else if ($(this.rows[i]).find('input[type="checkbox"]').prop('checked')) {
                                ids[j] = this.rows[i].id;
                                j++;
                            }
                        }
                ...
                if (nd.img == -1) {
                    ...
                    if (!!nd.img) {
                        ...
                        if (nd.img.indexOf('icon') < 0) {
                            html = "<img class=\"" + nd.img + "\"></i>"
                        }
                        ht.push(html);
                    } else {
                        ht.push("<i class=\"fa fa-user-md\" style='width:15px'></i>");
                    }
            } else {
                if (nd.img == -1) {
                    ht.push("");
        ...
        function nodeclick(e) {
            ...
            if (et.tagName == "IMG") {
                if ($(et).hasClass("bbit-tree-elbow-plus") || $(et).hasClass("bbit-tree-elbow-end-plus")) {
                    if ($(this).find('i').hasClass('fa-user-md')) {
                        $(this).find('i').swapClass('fa-user-md', 'fa-user-md');
                    }
                    var ul = $(this).next();
