(function ($) {
    ...
    $(function () {
        ...
        $("#btn_search").click(function () {
            ...
            $gridList.jqGrid('setGridParam', {
                postData: { location: $("#ydk").val(), d1: $("#F_Time1").val(), d2: $("#F_Time1").val(), strNo: $("#txt_keyword").val()}
    ...
    $.Index = {
        ...
        gridList: function () {
            var $gridList = $("#gridList");
            $gridList.dataGrid({
                url: "/YdkManage/Order/GetGridJson",
        ...
        btn_details: function () {
            ...
            $.modalOpen({
                id: "Form",
                title: "已完成提货单信息",
                url: "/YdkManage/Order/UnFinishedTruckForm?keyValue=" + keyValue,
                width: "450px",
                height: "500px",
                btn: null,
                callBack: null
